 ...
 * @version 1.0.1
 */
public class PhilospherMine extends Thread {
	
	private static int time = 10;
	
	private boolean eating;
	private PhilospherMine left;
	private PhilospherMine right;
	private ReentrantLock table;
	private Condition condition;
	
	private String name ;
	
	public PhilospherMine(ReentrantLock table , String name) {
		this.eating = false;
		this.table = table;
	...
	public void setLeft(PhilospherMine left) {
		this.left = left;
	}
	public void setRight(PhilospherMine right) {
		this.right = right;
	}
	...
	public static void main(String[] args) {
		...
		PhilospherMine p1 = new PhilospherMine(table , "东邪");
		PhilospherMine p2 = new PhilospherMine(table , "西毒"); 
		PhilospherMine p3 = new PhilospherMine(table , "中神");
		PhilospherMine p4 = new PhilospherMine(table , "南帝");
		PhilospherMine p5 = new PhilospherMine(table , "北丐");
		p1.setLeft(p5);
		p1.setRight(p2);
